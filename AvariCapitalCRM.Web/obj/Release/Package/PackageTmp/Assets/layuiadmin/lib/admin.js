    ...
    var events = admin.events = {
        ...
        , note: function (othis) {
            ...
            events.note.index = admin.popup({
                ...
                , content: '<textarea placeholder="Content"></textarea>'
                , resize: false
                , success: function (layero, index) {
                    var textarea = layero.find('textarea')
                        , value = note === undefined ? 'The contents of the note are stored locally, so that even if you close the browser, the next time you open it, the last record will still be read. A very small and practical local memo' : note;
