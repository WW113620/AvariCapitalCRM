    ...
    u.prototype.view = function() {
        ...
        var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1
          , i = {
            ...
            skip: function() {
                return ['<span class="layui-laypage-skip">Page skipping', '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', 'page<button type="button" class="layui-laypage-btn">OK</button>', "</span>"].join("")
            }()
        };
